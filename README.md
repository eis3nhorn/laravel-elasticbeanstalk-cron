...
*** This Fork uses getenv to get vars (like USE_CRONE) defined in Elastic Beanstalk Environment instead of using config to read them as it seems to fail on Elastic Beanstalk as of December 4 2018.
